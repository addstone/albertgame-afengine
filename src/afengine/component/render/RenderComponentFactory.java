...
public class RenderComponentFactory implements IComponentFactory {
    ...
    private RenderComponent createText(Element element, Map<String, String> datas) {
        ...
        if (null == colore) {
            ...
            if (colorv != null) {
                colorv = ActorComponent.getRealValue(colorv, datas);
                color = getColor(colorv);
            } else {
                colors = ActorComponent.getRealValue(element.elementText("color"), datas);
        ...
        if (backcolore != null) {
            ...
            if (backcolorv != null) {
                String backcolorvalue = ActorComponent.getRealValue(backcolorv, datas);
    ...
    private IColor getColor(String colorvalue) {
        ...
        IColor color = ((IGraphicsTech) ((WindowApp) AppState.getRunningApp()).
