...
public class ActionComponentFactory implements IComponentFactory{
    ...
    */
    ...
    public ActorComponent createComponent(Element element, Map<String, String> actordatas){
        ...
        Map<String, ActionComponent.ActAction> actionMap=new HashMap<>();
        while(eleiter.hasNext()){
            ...
            ActionComponent.ActAction act = createAction(ele,actordatas);
            if(act==null){
        ...
        List<ActionComponent.ActAction> actionList=mapAction(actionMap,actMap);
    ...
    private List<ActionComponent.ActAction> mapAction(Map<String, ActionComponent.ActAction> actionMap, Map<String,String> actMap){
        Iterator<Map.Entry<String,String>> entrtiter=actMap.entrySet().iterator();
        List<ActionComponent.ActAction> actionList=new LinkedList<>();
        Iterator<ActionComponent.ActAction> actiter=actionMap.values().iterator();
        while(actiter.hasNext()){
            ActionComponent.ActAction act = actiter.next();
            actionList.add(act);
        }
        ...
        while(entrtiter.hasNext()){
            ...
            ActionComponent.ActAction k = actionMap.get(key);
            ActionComponent.ActAction v = actionMap.get(value);
            if(k!=null&&v!=null){
                k.setNextAction(v);
                actionList.remove(v);
    ...
    */
    public static ActionComponent.ActAction createAction(Element element, Map<String,String> actordatas){
